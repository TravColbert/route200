<article id="mainwelcome" class="fullpage">
  <div class="container">
    ...
    <div id="regsterbutton">
      <a href="<?php echo $this->getConfig("prefixurl") ?>/register/" class="buttonstyle compact">sign up</a>
    </div>
  </div>
  <?php
  ...
  <div class="container wimpy">
    <div class="loginbox formbox">
      <form id="loginform" action="<?php echo $this->getConfig("prefixurl") ?>/login/" method="POST">
        <div class="fieldset">
